...
using LunarMenu.routines;
using LunarMenu.ui;
using UnityEngine;

namespace LunarMenu;

[BepInPlugin("com.outersloth.lunarmenu", "Lunar", "1.0.0.0")]
[BepInProcess("Among Us.exe")]
internal class Lunar : BasePlugin
{
	...
	public override void Load()
	{
		...
		{
			notifications.Send("Fatal Error", "Harmony patches failed to load, you are likely using an unsupported version. Check https://github.com/OuterslothAU/Lunar for more information.", 9999);
			throw;
		}
