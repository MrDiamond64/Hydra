...
namespace HydraMenu.routines
{
    internal class RoutineManager : MonoBehaviour
    {
        ...
        public AutoKickAll autoKickAll = new AutoKickAll();

        public readonly IRoutine[] routineList;

        public RoutineManager()
        {
            routineList = [autoTriggerSpores, discoHost, doorTroller, jailPlayer, petPlayer, playerFollower, reportBodySpam, teleportSpammer, autoKickAll];
        }
